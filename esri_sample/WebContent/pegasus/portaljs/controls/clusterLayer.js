...
define([
  ...
  return declare([GraphicsLayer], {
    constructor: function(options) {
      ...
      this.singleNodes = [];
      this.zoomEndListener = options.zoomEndListener || triggerMapZoomListener;
      this.showClusterAnalytics = true;
    },
    
    setShowClusterAnalytics: function(flag) {
    	this.showClusterAnalytics = flag;
    },
     
    setClusterData: function(data) {
    	if(data != undefined){
    ...
    addClusterData: function(point, data) {
    	if(point != undefined && this._clusterData != undefined){
    		if(data != undefined){
    ...
    _setMap: function(map, surface) {
      ...
      this._zoomEnd = connect.connect(map, "onZoomEnd", this, function(e) {
        // update resolution
        this._clusterResolution = this._map.extent.getWidth() / this._map.width;
        this.clear();
        this._clusterGraphics();        
        setTimeout(function(){
        	triggerMapZoomListener({level: map.getLevel()});
        }, 100);        
      });
    ...
    _showCluster: function(c) {
      ...
      if ( c.attributes.clusterCount == 1 ) {
    	  this.singleNodes[c.attributes.data.name] = c.attributes.data;
        return;
      }
      if(this.showClusterAnalytics){
    ...
    isSingleNode: function (locCd){
    	if(locCd != undefined){
    		if(this.singleNodes[locCd] != undefined){
    			return true;
    		}
    	}    	
    },

...
<html:html>
<head>
<title>Volume Utilization Tree Grid Matrix</title>
<!--  Kendo UI Framework -->
...
<script src="<%=contextName%>/pegasus/portaljs/volumeUtilizationTreeGridMatrix.js<%=jsVersion%>" type="text/javascript" ></script> 
<!-- day control -->
...
<body style="width:100%;height:100%" oncontextmenu="return false;">
  	<div id="volumeMatrixTreeGrid">
    	<div id="groupBar" class ="group-bar">Drag a column here to group by that column.</div>
    	<div id="volumeUtilizationTreeGridMatrixContainer" style="position: absolute;  left: 10px;right: 10px;top:60px; bottom: 10px;"></div>
	</div>
					...
					<tr>
						...
						<td class="settings-right-column" valign="top" width="50%">
							...
							<div class="section-box">
								...
								<!-- 	<tr height=10></tr> -->
										<tr>
											<td class="left-padding2" style="padding-top:4px"><input type="checkbox" class="mtrixchkbox" id="totalsforeachbreakChk" checked=true onclick="onTotalForEachBreak('volumeUtilizationTreeGridMatrixContainer', this)"/><label
										...
										<tr>
											<td class="left-padding2"><input type="checkbox" class="mtrixchkbox" id="grandtotalsChk" checked=true onclick="onGrandTotal('volumeUtilizationTreeGridMatrixContainer', this)"/><label
 ...
 <!--  <div id="volumeUtilizationMatrix" class="matrixDivStyle"> -->
   <!--  Progress Window Dialog placehodler  -->
	...
	<div id="headerButtonsBar" class="window-header k-window-actions btnBarPosition addOverflowStyle">
 		<div class="btnsWrapper">
	 		<a id="mRefresh" class="iconbtn" onclick="getDashboardContentWindow(DASHBOARD_ID_VOLUME_UTILIZATION_TREE_GRID_MATRIX).refreshMatrix(true,true)" title="<bean:message key='header.icon.refresh' bundle='matrixresources'/>" href="#">
	    	...
	    	<a id="" class="iconbtn" onclick="getDashboardContentWindow(DASHBOARD_ID_VOLUME_UTILIZATION_TREE_GRID_MATRIX).exportToExcel(this)" title="<bean:message key='header.icon.exportto.excel' bundle='matrixresources'/>" href="#">
	    	...
	    	<%-- <a id="toggleMZulu" onclick="getDashboardContentWindow(DASHBOARD_ID_VOLUME_UTILIZATION_TREE_GRID_MATRIX).showLocalZuluColumns(this)" toggled=true class="iconbtn" title="<bean:message key='header.icon.zulu' bundle='matrixresources'/>" href="#">
	    		<span class="k-icon icon-toggle-local">
	    			<bean:message key='header.icon.zulu' bundle='matrixresources'/>
	    		</span>
	    	</a> --%>
	 		<a id="mnCal" onclick="getDashboardContentWindow(DASHBOARD_ID_VOLUME_UTILIZATION_TREE_GRID_MATRIX).openDayControl(this)" class="iconbtn" title="<bean:message key='header.icon.calendar' bundle='matrixresources'/>" href="#">
   ...
   <div id ="favoriteWindowsParentDiv" style="display: none;"></div>
    	...
    	<input type="hidden" id="matrixId" name="matrixId" value="VolUtilizationTreeGridMatrix">
	</form>
 </html:html>
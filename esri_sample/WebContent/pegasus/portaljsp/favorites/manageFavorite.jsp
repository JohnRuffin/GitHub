...
<script>
	$(document).ready(function() {
 	...
 	function closeFavoriteWindow() {
 		parent.getFavoriteComponent('<bean:write name="favoriteId" />').closeManageFavoriteWindow();
 	}
</script>
</head>
		...
		<table border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td valign="top">
			    	<table border="0">
						...
						<tr>
							<td><select id="manageDisplayFavoritesSelect" size="10" multiple="multiple" onchange = "enableDisplayFavoritesBtns('manageDisplayFavoritesSelect','<bean:write name="favoriteId" />')" style="width:145px;height:190px"/></td>
						</tr>		
					</table>
				</td>
				<td class="left-padding2" valign="top">
					<table border="0" style="margin-top:25px;">
							  ...
							  <tr style="display:none;"><td><button id="manageDisplayFavoritesMoveLeft" disabled ="true" onclick="acceptSharedFavorites('<bean:write name="favoriteId" />')" style="width:100px"><div class="inline-block" style="vertical-align:middle; margin-top:-4px;">Move</div><div class="arrow-left inline-block left-margin1"></div></td></tr> 
							  <tr height = "5px"/>
				...
				<div id = "shared">
				  	<td id = "shared1" style = "padding-left:5px" valign="top">
						<table border = "0" style ="display:none">
					   		<tr height = "8%"><td><label style = "padding-left:15px; padding-top:3px;">Shared Favorites</label></td></tr>
					   		<tr height = "10px"/>
					   		<tr>
							   	<td >
						   	...
						   	<tr>
							  <td>
								 <select name="manageDisplayFavoritesSharedSelect" id="manageDisplayFavoritesSharedSelect" size="18" multiple="multiple" height = "80%" style="width: 100px;height:190px"  onchange = "enableDisplayFavoritesBtns('manageDisplayFavoritesSharedSelect','<bean:write name="favoriteId" />')"/>
							  </td>
						   	</tr>
				  		</table>
					 </td>
			...
			<tr>
			  	<td colspan="3" align="right" style="padding-top:5px;">
					<input type="button" id="manageDisplayFavoritesSave" value="OK" onclick = "performSaveHandler(false,'<bean:write name="favoriteId" />');" disabled = "true" style="width:80px; margin-right:10px;">
					<input type="button" id="btnManageFavoritesCancel" onclick = "closeManageFavorite('<bean:write name="favoriteId" />');" value="Cancel" style="width:80px; margin-right:10px;">
				</td>
		    </tr>
	  	</table>
	</div>   	

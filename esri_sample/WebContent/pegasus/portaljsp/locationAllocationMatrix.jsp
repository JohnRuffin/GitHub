...
<script src="<%=contextName%>/pegasus/portaljs/locationAllocationMatrix.js<%=jsVersion%>" type="text/javascript" ></script> 
					...
					<tr>
						...
						<td class="settings-right-column" valign="top" width="50%">
							...
							<div class="section-box" style="height: 100px">
								...
								<!-- 	<tr height=10></tr> -->
										<tr>
											<td class="left-padding2" style="padding-top:4px"><input type="checkbox" class="mtrixchkbox" id="totalsforeachbreakChk" checked=true onclick="onTotalForEachBreak(locAllocMatrixGrid, this)"/><label
										...
										<tr>
											<td class="left-padding2"><input type="checkbox" class="mtrixchkbox" id="grandtotalsChk" checked=true onclick="onGrandTotal(locAllocMatrixGrid, this)"/><label
